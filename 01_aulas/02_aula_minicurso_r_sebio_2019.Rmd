...
1. **Valores** ou **Objetos**: a função irá **alterar os valores** em si ou os atribuídos aos objetos

--

2. **Parâmetros**: valores fixos que informam um **método** ou a realização de uma **operação**. Informamos o **nome desse argumento**, seguido de **"="** e um *número*, *texto* ou *TRUE* ou *FALSE*.
